...
urlpatterns = [
    ...
    url(r'^friend_requests/$', views.friend_requests, name='webapp/friend_requests.html'),
    url(r'^friend_requests/accept/$', views.accept_friend, name='webapp/accept_friend'),
